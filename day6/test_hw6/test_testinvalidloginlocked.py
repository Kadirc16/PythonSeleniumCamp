...
class TestTestinvalidloginlocked():
  ...
  def test_testinvalidloginlocked(self):
    ...
    self.driver.find_element(By.ID, globalConstants.idButton).send_keys("locked_out_user")
    ...
    self.driver.save_screenshot(f"{self.folderPath}/test-invalid-login-locked.png")
    
    assert self.driver.find_element(By.XPATH, "//div[@id=\'login_button_container\']/div/form/div[3]/h3").text == globalConstants.textLockedUser
